...
With a representation of embedded dependencies in hand, first goal of the chase step is to find a tableau homomorphism from the query to the front of the embedded dependency.
